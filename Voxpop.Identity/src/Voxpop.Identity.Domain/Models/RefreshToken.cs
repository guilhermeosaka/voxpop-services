...
public class RefreshToken(Guid id, Guid userId, string tokenId, string tokenHash, DateTimeOffset expiresAt)
{
    ...
    public static RefreshToken Create(Guid userId, string tokenId, string tokenHash, DateTimeOffset expiresAt) =>
