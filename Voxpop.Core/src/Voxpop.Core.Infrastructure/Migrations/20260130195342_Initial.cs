        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    vote_mode = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_profiles_cities_city_id",
                        column: x => x.city_id,
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_profiles_education_levels_education_level_id",
                        column: x => x.education_level_id,
                        principalTable: "education_levels",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_profiles_ethnicities_ethnicity_id",
                        column: x => x.ethnicity_id,
                        principalTable: "ethnicities",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_profiles_genders_gender_id",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_profiles_races_race_id",
                        column: x => x.race_id,
                        principalTable: "races",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_profiles_religions_religion_id",
                        column: x => x.religion_id,
                        principalTable: "religions",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_profiles_states_state_id",
                        column: x => x.state_id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_profiles_education_level_id",
                table: "profiles",
                column: "education_level_id");

            migrationBuilder.CreateIndex(
                name: "IX_profiles_ethnicity_id",
                table: "profiles",
                column: "ethnicity_id");

            migrationBuilder.CreateIndex(
                name: "IX_profiles_gender_id",
                table: "profiles",
                column: "gender_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_profiles_religion_id",
                table: "profiles",
                column: "religion_id");

            migrationBuilder.CreateIndex(
                name: "IX_profiles_state_id",
                table: "profiles",
                column: "state_id");
